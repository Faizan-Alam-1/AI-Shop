...
document.addEventListener("DOMContentLoaded", () => {
  const start = async () => {
    ...
    occluder.scene.scale.set(0.01 ,0.01 ,0.01);
    occluder.scene.position.set(0.01, 0.01, 0.01);
    ...
    const glasses = await loadGLTF("../Product_model/wayfarer_frame/scene.gltf");
    glasses.scene.scale.set(0.5, 0.5, 0.5);
